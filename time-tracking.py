...
if __name__ == '__main__':
    ...
    new_conditional.add_argument('-salary', help='specify salary (when creating a project)')
    new_conditional.add_argument('-total', help='specify total amount of hours allocated for a project (when creating a project)')
